...
from app.schemas import ManagerAssignmentCreate, ManagerAssignmentResponse, MessageResponse
...
async def create_assignment(
    ...
    existing = await db.execute(
        select(ManagerEmployee).where(
            ManagerEmployee.manager_id == payload.manager_id,
            ManagerEmployee.employee_id == payload.employee_id,
        )
    )
